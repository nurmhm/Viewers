...
LayoutSelector2.Trigger = Trigger;
LayoutSelector2.Content = Content;
LayoutSelector2.PresetSection = PresetSection;
LayoutSelector2.Preset = Preset;
LayoutSelector2.GridSelector = GridSelector;
LayoutSelector2.Divider = Divider;
LayoutSelector2.HelpText = HelpText;

// PropTypes
LayoutSelector2.propTypes = {
